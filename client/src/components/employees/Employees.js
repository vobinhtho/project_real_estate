...
export default function Employees() {
  ...
  const employees = useSelector((state)=>state.user.filter(x => x.role==='nhanvien' || x.role==='admin'))
  ...
  return (
    ...
    <DialogTitle id="customized-dialog-title" onClose={handleClose}>
      ...
      <Box flexGrow={1} >Thêm Nhân Viên</Box>
        <Box>
    ...
    <Table>
      <TableRow>
        <TableCell><Button variant="contained" color="primary" startIcon={<AddCircleIcon/>} onClick={handleClickOpen}>Add Employee</Button></TableCell>
        <TableCell>
