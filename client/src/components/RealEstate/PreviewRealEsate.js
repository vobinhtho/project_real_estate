...
import useStyles from '../homepages/styles'
...
import BookRealEstate from "../homepages/BookRealEstate";
...
import ChatBotReal from "../homepages/chatBot/ChatBotReal";
...
const PreviewRealEstate = ({realid}) =>{
    ...
    const realestateAll = useSelector(state=>state.realestate)
    ...
    return(
        ...
        <DialogContent dividers>
            <BookRealEstate id={realid}  handleClose={handleClose}/>
        </DialogContent>
                ...
                <Card>
                    ...
                    <Grid xs={8}>
                        ...
                        <Typography gutterBottom className={classes.colorIcon}>
                            <FaPhoneAlt/> <b> {item.phone_number}</b>
                        </Typography>
...
export default PreviewRealEstate;